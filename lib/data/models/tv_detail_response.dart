...
class TvDetailResponse extends Equatable {
  ...
  factory TvDetailResponse.fromJson(String str) => TvDetailResponse.fromMap(
        json.decode(str),
      );
  ...
  factory TvDetailResponse.fromMap(Map<String, dynamic> json) =>
      TvDetailResponse(
        ...
        lastEpisodeToAir: LastEpisodeToAirModel.fromMap(
